...
CREATE TABLE `PRIEST` (
  `PRIEST_ID` varchar(255) PRIMARY KEY,
  `PID` varchar(255)
);
...
ALTER TABLE `PRIEST` ADD FOREIGN KEY (`PID`) REFERENCES `PERSONS` (`PID`);

ALTER TABLE `PARENTS` ADD FOREIGN KEY (`MOTHER_ID`) REFERENCES `PERSONS` (`PID`);

ALTER TABLE `PARENTS` ADD FOREIGN KEY (`FATHER_ID`) REFERENCES `PERSONS` (`PID`);
...
ALTER TABLE `DEATH` ADD FOREIGN KEY (`priest_id`) REFERENCES `PRIEST` (`PRIEST_ID`);
...
ALTER TABLE `BAPTISM` ADD FOREIGN KEY (`PARENTS_ID`) REFERENCES `PARENTS` (`PARENT_ID`);
...
ALTER TABLE `CONFIRMATION` ADD FOREIGN KEY (`PARENTS_ID`) REFERENCES `PARENTS` (`PARENT_ID`);

ALTER TABLE `CONFIRMATION` ADD FOREIGN KEY (`g_PERSONS_ID`) REFERENCES `G_PERSONS` (`G_PERSONS_ID`);

ALTER TABLE `CONFIRMATION` ADD FOREIGN KEY (`PRIEST_ID`) REFERENCES `PRIEST` (`PRIEST_ID`);
...
ALTER TABLE `MARRIAGE_` ADD FOREIGN KEY (`PRIEST_ID`) REFERENCES `PRIEST` (`PRIEST_ID`);
...
ALTER TABLE `COUPLES` ADD FOREIGN KEY (`PARENTS_ID`) REFERENCES `PARENTS` (`PARENT_ID`);
...
ALTER TABLE `WITNESS` ADD FOREIGN KEY (`MARRIAGE_ID`) REFERENCES `MARRIAGE_` (`MARRIAGE_ID`);

ALTER TABLE `WITNESS` ADD FOREIGN KEY (`MALE_WITNESS_ID`) REFERENCES `PERSONS` (`PID`);

ALTER TABLE `WITNESS` ADD FOREIGN KEY (`FEMALE_WITNESS_ID`) REFERENCES `PERSONS` (`PID`);
